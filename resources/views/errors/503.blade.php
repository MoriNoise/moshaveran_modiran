...
@section('title', '۵۰۳ - سرویس در دسترس نیست')

@section('content')
    <p class="error-text mb-4 text-fixed-white">۵۰۳</p>
    <p class="fs-23 fw-medium mb-2 text-fixed-white">سرویس در حال حاضر در دسترس نیست!</p>
