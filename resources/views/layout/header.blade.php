...
<header class="header">
    ...
    <div class="container mt-5 hidden flex-col gap-y-6 lg:flex">
        ...
        <div class="flex-between">
            ...
            <div class="relative z-20">
                ...
                <div
                    ...
                    <input placeholder="جستجو در {{config("project.project_name")}}..." type="text">
                </div>
                <!-- Search Modal -->
            ...
            <!-- Logo -->
            <a href="{{route('home.index')}}" class="flex flex-col text-center ml-20">
                    <span class="font-MorabbaMedium text-4xl flex items-center">
                        <span class="text-blue-500">{{config("project.project_name")}}</span> فروشگاه
                    </span>
        ...
        <div class="relative flex-between h-16 bg-gray-900 dark:bg-gray-800 rounded-full text-gray-200 px-10">
            ...
            <ul class="flex items-center gap-x-8">
                <li class="menu-item">
                    <a href="{{route('home.index')}}" class="menu-item_link">
                        صفحه اصلی
                    </a>
                </li>
                <!-- MENU ITEM --- Mega Menu -->
                ...
                <li class="menu-item">
                    <a href="{{route('shop.index')}}" class="menu-item_link">
                        فروشگاه
                    </a>
                </li>
                <li class="menu-item">
            ...
            <div class="relative">
                <button class="flex items-center gap-x-1 citylist-open">
                    ...
                    <p>
                        {{ $defaultAddress ? $defaultAddress->title : 'آدرس خود را انتخاب کنید' }}
                    </p>
                </button>
                ...
                <div class="citylist-menu z-30">
                    ...
                    <h2 class="my-3 pr-1.5 font-DanaMedium">آدرس های شما :</h2>

                    <!-- Address list -->
                    <ul class="city-list">
                        @foreach($addresses as $address)
                            <li>
                                <a href="#" class="{{ $address->is_default ? 'font-bold text-blue-500' : '' }}">
                                    <svg class="size-5">
                                        <use href="#map" />
                                    </svg>
    ...
    <div class="flex justify-center lg:hidden">
        ...
        <nav
            ...
            <div class="mobile-menu z-50 flex flex-col">
                ...
                <div class="flex w-full items-center justify-between border-b-normal pb-4">
                    <a href="{{route('shop.index')}}" class="text-xl font-MorabbaMedium">
                        <span class="text-blue-500">{{config("project.project_name")}}</span> فروشگاه
                    </a>
            ...
            <!-- Logo -->
            <a href="{{route('home.index')}}" class="flex flex-col text-center">
        ...
        <button class="open-mobile_search-modal">
            ...
            <p>جستجو در <span class="font-MorabbaMedium">{{config("project.project_name")}} شاپ</span></p>
        </button>
        <!-- Search Moadal -->
            ...
            <div dir="rtl" class="swiper header-slider h-52 md:h-96 cursor-pointer">
                <div class="swiper-wrapper">
                    @foreach($sliders as $slider)
                        <a href="{{ $slider->link ?? '#' }}" class="swiper-slide">
                            <img src="{{ getSliderImageUrl($slider) }}" class="rounded-xl" alt="{{ $slider->title ?? '' }}">
                        </a>
                    @endforeach
                </div>
