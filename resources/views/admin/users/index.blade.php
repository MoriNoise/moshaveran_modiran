                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    ...
                                    <select id="choices-single-default" class="form-control" name="sort">
                                        ...
                                        <option value="name_asc" {{ request('sort') == 'name_asc' ? 'selected' : '' }}>الفبا (الف - ی)</option>
                                        <option value="name_desc" {{ request('sort') == 'name_desc' ? 'selected' : '' }}>الفبا (ی - الف)</option>
                                        <option value="Date Added" {{ request('sort') == 'Date Added' ? 'selected' : '' }}>تاریخ اضافه شدن</option>
                                        <option value="Newest" {{ request('sort') == 'Newest' ? 'selected' : '' }}>جدیدترین</option>
                                        <option value="Type" {{ request('sort') == 'Type' ? 'selected' : '' }}>نوع</option>
                                    </select>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2" role="search">
                                    ...
                                    <input class="form-control" type="search" name="search"
                                           placeholder="جستجوی کاربر" value="{{ request('search') }}" style="min-width: 200px;">

                                    <!-- Gender Filter -->
                                    <select id="choices-single-default" class="form-control" name="gender" style="min-width: 150px;">
                                        ...
                                        <option value="other" {{ request('gender') == 'other' ? 'selected' : '' }}>نامشخص</option>
                                    </select>
