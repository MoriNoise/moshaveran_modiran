                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control" name="username"
                                               value="{{ old('username', $admin->username) }}" placeholder="نام کاربری">
                                    </div>
                                    <div class="col-xl-6">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <select class="form-control" name="is_super">
                                            <option value="1" {{ old('is_super', $admin->is_super) == 1 ? 'selected' : '' }}>
                                                مدیر کل
                                            </option>
                                            <option value="0" {{ old('is_super', $admin->is_super) == 0 ? 'selected' : '' }}>
                                                عادی
                                            </option>
                                        </select>
                                    </div>
